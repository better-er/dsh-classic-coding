  ...
  factory: function (require) {
      ...
      function handleClick() {
        if (isDir) {
          if (state.expandedDirs[fullPath]) {
            ...
            if (!children) {
              setLoading(true)
              rpcCall('listDir', { path: fullPath }).then(function (result) {
    ...
    function FileTree(props) {
      ...
      React.useEffect(function () {
        rpcCall('describe').then(function (result) {
          state.root = result.root
          return rpcCall('listDir', { path: '' })
    ...
    function EditorPanel(props) {
      ...
      function openFile(filePath) {
        ...
        rpcCall('readFile', { path: filePath }).then(function (result) {
      ...
      function saveFile(filePath) {
        ...
        rpcCall('writeFile', { path: filePath, content: tab.content }).then(function () {
          tab.modified = false
    ...
    function TriggerButton() {
      ...
      React.useEffect(function () {
        state._setTriggerIsOpen = setIsOpen
        return function () { state._setTriggerIsOpen = null }
      }, [])
      ...
      var icon = isOpen ? '\u2716' : '\u2328'
      var title = isOpen ? '关闭古法编程' : '古法编程 (Classic Coding)'
      ...
      return React.createElement('button', {
        ...
        React.createElement(
          ...
          React.createElement('span', { className: 'dsh-cc-trigger-icon', 'aria-hidden': 'true' }, icon),
          React.createElement('span', { className: 'dsh-cc-trigger-title' }, '古法编程')
        ),
        React.createElement('div', { className: 'dsh-cc-trigger-desc' },
          isOpen ? '点击关闭编辑器' : '打开文件编辑器'
        )
      )
    }
